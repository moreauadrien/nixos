...
stdenv.mkDerivation {
  ...
  meta = {
    ...
    description = "Minimalist version of Brave browser without crypto, AI, and rewards features";
    longDescription = ''
      Brave Origin is a minimalist, paid version of the Brave browser
      that strips out cryptocurrency, AI, rewards, and other
      monetization-focused features. On Linux, it is available for free.
    '';
